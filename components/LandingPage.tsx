...
import { ShieldCheck, Zap, Users, BarChart3, Mail, Phone, MapPin, ArrowRight, ChevronDown, BookOpen, Globe, lightbulb } from "lucide-react";
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center overflow-hidden pt-16 lg:pt-0">
        <motion.div style={{ y: textY, opacity: heroOpacity }} className="z-10 px-4 sm:px-6 lg:px-6">
          ...
          <div className="mt-8 flex flex-col items-center gap-2">
             <span className="text-xs tracking-[0.3em] uppercase text-blue-500 font-bold">Led by CEO Jirlo Jayan</span>
             <span className="text-white/30 text-sm">Backed by iQue Ventures</span>
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="flex-1 bg-[#1D1D1F] border border-white/10 rounded-l-3xl p-8 md:p-16 flex flex-col justify-center shadow-2xl">
              ...
              <p className="text-2xl md:text-4xl font-bold leading-tight tracking-tight">
                To establish India as a <span className="text-white/40">dominant global startup hub</span> by providing knowledge, infrastructure, and capital.
              </p>
            </div>
            ...
            <div className="flex-1 bg-[#1D1D1F] border border-white/10 rounded-r-3xl p-8 md:p-16 flex flex-col justify-center shadow-inner">
              ...
              <p className="text-xl md:text-2xl font-medium text-white/80 leading-relaxed">
                To identify, educate, build, and scale startups through a practical, structured approach—transforming ideas into viable businesses.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                <h3 className="text-5xl font-black italic tracking-tighter">THE CORE</h3>
                <p className="mt-4 text-white/60 font-medium">Scroll to reveal our roadmap</p>
              </div>
      ...
      <section id="about" className="py-20 lg:py-32 px-4 lg:px-6 max-w-[1200px] mx-auto">
        <FadeIn>
          <h2 className="text-3xl lg:text-4xl xl:text-6xl font-bold tracking-tight mb-12 lg:mb-20 text-center">
            Bridging the gap between <br/> <span className="text-blue-500">raw ideas and global success.</span>
          </h2>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-6">
          <motion.div whileHover={{ scale: 0.98 }} className="sm:col-span-2 lg:col-span-8 bg-[#1D1D1F] rounded-2xl lg:rounded-[2.5rem] p-6 lg:p-12 relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <h3 className="text-2xl lg:text-3xl font-bold mb-3 lg:mb-4">iQue Ventures Backbone</h3>
              <p className="text-white/40 max-w-sm text-sm lg:text-lg">
                Leveraging the experience and network of iQue Ventures to provide venture building and strategic consulting.
              </p>
            </div>
          ...
          <motion.div whileHover={{ scale: 0.98 }} className="sm:col-span-2 lg:col-span-4 bg-[#1D1D1F] rounded-2xl lg:rounded-[2.5rem] p-6 lg:p-10 flex flex-col justify-end border border-white/5">
            ...
            <h3 className="text-xl lg:text-2xl font-bold mb-2">Educate & Empower</h3>
            <p className="text-white/40 text-xs lg:text-sm">Providing aspiring entrepreneurs with the knowledge to lead.</p>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 0.98 }} className="sm:col-span-2 lg:col-span-4 bg-blue-600 rounded-2xl lg:rounded-[2.5rem] p-6 lg:p-10 text-white">
            ...
            <h3 className="text-xl lg:text-2xl font-bold mb-2">Global Expansion</h3>
            <p className="text-white/80 text-xs lg:text-sm">Enabling entry into international markets and attracting global capital.</p>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 0.98 }} onClick={onStartJourney} className="sm:col-span-2 lg:col-span-8 bg-white text-black rounded-2xl lg:rounded-[2.5rem] p-6 lg:p-10 flex flex-col sm:flex-row items-center justify-between cursor-pointer group">
            <div className="mb-4 sm:mb-0">
              <h3 className="text-2xl lg:text-3xl font-bold">Scaling India's Potential?</h3>
              <p className="text-black/50">Join the full-stack ecosystem built for Bharat.</p>
            </div>
      ...
      <section id="services" className="bg-[#f5f5f7] text-black py-20 lg:py-32 rounded-2xl lg:rounded-[4rem] mx-4 lg:mx-0">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            <div>
              <span className="text-blue-600 font-bold tracking-widest uppercase text-xs">Core Offerings</span>
              <h2 className="text-3xl lg:text-5xl font-bold tracking-tight mt-4 lg:mt-6 mb-6 lg:mb-8">Full-Stack Facilitation.</h2>
              <p className="text-black/60 text-lg">Guided by a panel of industry experts and business strategists to ensure market access and scale.</p>
            </div>
            <div className="space-y-8 lg:space-y-12">
              {[
                { title: "Entrepreneur Education", desc: "Workshops for foundational startup knowledge." },
                { title: "Venture Building", desc: "Support for idea validation and product development." },
                { title: "Startup Infrastructure", desc: "Collaborative and physical innovation spaces." },
                { title: "Scaling & Consulting", desc: "Guidance for sales, marketing, and expansion." },
                { title: "Capital Access", desc: "Connecting founders with global funding networks." },
                { title: "Global Expansion", desc: "Facilitating entry into international markets." }
              ].map((service, i) => (
                <FadeIn key={i} delay={i * 0.1}>
                  <div className="flex gap-4 lg:gap-6 border-b border-black/5 pb-6 lg:pb-8">
                    ...
                    <div>
                      <p className="text-lg lg:text-xl font-bold text-black/90">{service.title}</p>
                      <p className="text-sm lg:text-base text-black/50">{service.desc}</p>
                    </div>
                  </div>
                </FadeIn>
              ))}
      ...
      <section id="contact" className="py-20 lg:py-32 px-4 lg:px-6">
        <div className="max-w-[1200px] mx-auto bg-[#1D1D1F] rounded-2xl lg:rounded-[3rem] p-6 lg:p-12 xl:p-24 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            <h2 className="text-3xl lg:text-5xl xl:text-7xl font-bold tracking-tighter mb-6 lg:mb-8">Empower. <br/> Scale. Connect.</h2>
            <div className="space-y-3 lg:space-y-4 text-white/50 text-sm lg:text-base">
              <p className="flex items-center justify-center lg:justify-start gap-3"><Mail size={16} className="lg:w-5 lg:h-5"/> info@bisf-india.com</p>
              <p className="flex items-center justify-center lg:justify-start gap-3"><Phone size={16} className="lg:w-5 lg:h-5"/> +91 90361 54395</p>
              <p className="flex items-center justify-center lg:justify-start gap-3"><MapPin size={16} className="lg:w-5 lg:h-5"/> Bangalore, India</p>
              <p className="mt-6 text-blue-500 font-semibold italic">“Connecting India to the World.”</p>
            </div>
          </div>
          <div className="flex-1 w-full space-y-4">
            <input type="text" placeholder="Startup Name" className="w-full bg-black/40 border border-white/10 p-4 lg:p-5 rounded-2xl outline-none focus:border-blue-500 transition-colors text-sm lg:text-base" />
            ...
            <textarea placeholder="How can we help you scale?" rows={4} className="w-full bg-black/40 border border-white/10 p-4 lg:p-5 rounded-2xl outline-none focus:border-blue-500 transition-colors text-sm lg:text-base"></textarea>
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 lg:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12 lg:mb-16">
            ...
            >
              ...
              <p className="text-white/50 text-sm leading-relaxed">Bharat Innovations & Startups Facilitator LLP (BISF). Strengthening India’s global position in the startup ecosystem.</p>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-3">
                {["About", "Advisory Board", "Global Presence"].map((item, i) => (
                  <li key={i}>
          ...
          >
            ...
            <p className="text-white/40 text-xs text-center">A Venture Backed by iQue Ventures</p>
          </motion.div>
        </div>
      </footer>
    </div>
